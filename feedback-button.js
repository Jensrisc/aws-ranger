(function () {
    ...
    const loginBase = 'iad.merlon.amazon.dev/console?awsAccountId=089910738259&awsPartition=aws&accountName=EURME-PredictiveAnalytics&sessionDuration=43200&iamRole=arn:aws:iam::089910738259:role/S3_Ranger_Tech';
    const finalPrefix = 's3/upload/ranger-production?region=eu-west-1&bucketType=general&prefix=feedback/';
