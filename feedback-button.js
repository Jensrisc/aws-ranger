// ==UserScript==
// @name         AWS Ranger – Feedback Upload
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Öffnet AWS Login mit Weiterleitung zum Feedback Upload
// @grant        none
// ==/UserScript==

window.onFeedbackButtonClick = function () {
    const targetUrl = 'https://eu-west-1.console.aws.amazon.com/s3/upload/ranger-production?region=eu-west-1&bucketType=general&prefix=feedback/';
