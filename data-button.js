...
// @version      1.1
// @description  Öffnet AWS-Login und navigiert nach erfolgreicher Weiterleitung zur Data-S3-Upload-URL
// @grant        none
// ==/UserScript==
    ...
    const checkInterval = setInterval(() => {
        try {
            if (win && win.location && win.location.href.includes("console.aws.amazon.com/console/home")) {
                ...
                const finalUrl = `https://${tokenHost}/s3/upload/ranger-production?region=eu-west-1&bucketType=general&prefix=data/`;
